...
#ifndef POTBOT_PLUGIN__PARTICLE_SWARM_OPTIMIZATION_H_
#define POTBOT_PLUGIN__PARTICLE_SWARM_OPTIMIZATION_H_
...
private:
      ...
      void reconfigureCB(
        const potbot_plugin::ParticleSwarmOptimizationConfig & param,
        uint32_t level);

      void pointvec_to_pcl(
      ...
      void point_to_marker(
        ...
        visualization_msgs::Marker & marker_output);
      void mat_to_marker_points(
        const Eigen::MatrixXd & points_input,
        visualization_msgs::Marker & marker_output);
      void path_to_line_marker(
...
#endif  // POTBOT_PLUGIN__PARTICLE_SWARM_OPTIMIZATION_H_
