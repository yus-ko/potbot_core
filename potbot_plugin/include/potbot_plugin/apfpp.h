...
#ifndef POTBOT_PLUGIN__APFPP_H_
#define POTBOT_PLUGIN__APFPP_H_
...
private:
      ...
      // dynamic_reconfigure::Server<potbot_plugin::ParticleSwarmOptimizationConfig>
      //   *dsrv_;
      // void reconfigureCB(
