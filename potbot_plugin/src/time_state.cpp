...
{
using potbot_lib::utility::get_path_index;
using potbot_lib::utility::broadcast_frame;
using potbot_lib::utility::get_tf;
using potbot_lib::utility::to_agent;
using potbot_lib::utility::to_msg;
using potbot_lib::utility::set_path_orientation;
...
void TimeState::initialize(std::string name, tf2_ros::Buffer * tf)
{
  ...
  dynamic_reconfigure::Server<potbot_plugin::TimeStateConfig>::CallbackType cb = boost::bind(
    &TimeState::reconfigureCB, this, _1, _2);
