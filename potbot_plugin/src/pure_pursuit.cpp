...
void PurePursuit::initialize(std::string name, tf2_ros::Buffer * tf)
{
  ...
  dynamic_reconfigure::Server<potbot_plugin::PurePursuitConfig>::CallbackType cb = boost::bind(
    &PurePursuit::reconfigureCB, this, _1, _2);
...
void PurePursuit::getLookahead(visualization_msgs::Marker & marker_msg)
{
  ...
  marker_msg.pose = potbot_lib::utility::get_pose(
    lookahead.position.x, lookahead.position.y, 0, 0,
    0, lookahead.rotation.z);
