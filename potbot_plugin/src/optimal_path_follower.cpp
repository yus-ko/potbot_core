...
namespace potbot_nav
{
    namespace controller
    {
        ...
        void OptimalPathFollower::configure(
        ...
        void OptimalPathFollower::cleanup()
        {
            RCLCPP_INFO(
                logger_,
                "Cleaning up controller: %s of type pure_pursuit_controller::OptimalPathFollower",
                plugin_name_.c_str());
            global_pub_.reset();
        }

        void OptimalPathFollower::activate()
        {
            RCLCPP_INFO(
                logger_,
                "Activating controller: %s of type pure_pursuit_controller::OptimalPathFollower\"  %s",
                plugin_name_.c_str(), plugin_name_.c_str());
            global_pub_->on_activate();
        }

        void OptimalPathFollower::deactivate()
        {
            RCLCPP_INFO(
                logger_,
                "Dectivating controller: %s of type pure_pursuit_controller::OptimalPathFollower\"  %s",
                plugin_name_.c_str(), plugin_name_.c_str());
            global_pub_->on_deactivate();
        }

        void OptimalPathFollower::setSpeedLimit(const double &speed_limit, const bool &percentage)
        {
            (void)speed_limit;
            (void)percentage;
        }

        geometry_msgs::msg::TwistStamped OptimalPathFollower::computeVelocityCommands(
        ...
        void OptimalPathFollower::setPlan(const nav_msgs::msg::Path &path)
        {
        ...
        nav_msgs::msg::Path
        OptimalPathFollower::transformGlobalPlan(
            const geometry_msgs::msg::PoseStamped &pose)
        {
        ...
        bool OptimalPathFollower::transformPose(
...
PLUGINLIB_EXPORT_CLASS(potbot_nav::controller::OptimalPathFollower, nav2_core::Controller)